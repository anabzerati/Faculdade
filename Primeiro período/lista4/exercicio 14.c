...
{ setlocale(LC_ALL,"portuguese");
	...
	if (c1+c2+c3+c4!=0)	
	 	printf("\n\nVotos v�lidos: %d, representando %.2f%% do total de votos",c1+c2+c3+c4, ((float)(c1+c2+c3+c4)/(float)total)*100);
	else
	 	printf("\n\nVotos v�lidos: %d, representando %.2f%%",c1+c2+c3+c4, (float)c1+c2+c3+c4);
